  ...
  return (
    ...
    <div className="flex bg-[#f9f5f0] w-1/2 mx-auto p-8 shadow-2xl rounded-lg mt-8">
      ...
      <div className="flex flex-col w-1/2 gap-8 p-4">
        ...
        <div>
          <p className="text-xl font-semibold text-gray-700">Weekend Brunch</p>
          <p className="text-lg font-medium text-red-600">
        ...
        <div>
          ...
          <p className="text-lg font-medium text-red-600">
            Bar is open daily until 11:00 pm on weekends, serving food and
            drinks continuosly. No reservations- just walk in.
          </p>
        </div>
        <button
