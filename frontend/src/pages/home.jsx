        ...
        <>
            <div className="grid grid-cols-2 pt-8 ">
                <div className="" >
                    ...
                    <div
                        className="text-[#2A435D] uppercase text-4xl pt-4 font-bold italic"
            ...
            <div className="">
                <div className="flex flex-col items-center justify-center pt-16 ">
                    <p className="text-2xl text-[#2A435D] font-semibold">
                        Food Items
                    </p>
                    <p className="text-[#c74040] text-4xl font-bold">
                        Popular Dishes
                    </p>
                </div>
            ...
            <div className="flex items-center justify-between gap-8 py-8">
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <p className="text-lg text-[#2A435D] font-semibold ">
                        Name Surname
                    </p>
